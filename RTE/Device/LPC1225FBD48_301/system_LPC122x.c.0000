...
//                     <i> M = MSEL + 1
//                   <0-31>
//     <o3.0..4>   PSEL: Post Divider Selection
//                   <0=> P = 1
//                   <1=> P = 2
//                   <2=> P = 4
//                   <3=> P = 8
...
//     <o6.0..7>   DIV: Clock Source for Main Clock
...
void SystemInit (void) {
  ...
  LPC_WDT->MOD  &= ~(WDMOD_Val);                  /* set Watchdog enable bit  */
  LPC_WDT->FEED  = 0xAA;                          /* Feeding sequence         */
  LPC_WDT->FEED  = 0x55;

  LPC_SYSCON->SYSAHBCLKCTRL = clkctrl;            /* Default AHBCLKCTRL       */
#endif
...
#if (WD_SETUP)                                    /* Watchdog Setup           */
  /* add code to configure watchdog */
#endif
